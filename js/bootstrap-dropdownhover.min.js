...
*/
/*https://translate.googleusercontent.com/translate_c?act=url&depth=1&hl=es&ie=UTF8&prev=_t&rurl=translate.google.com&sl=en&sp=nmt4&tl=es&u=https://stackoverflow.com/questions/12115833/adding-a-slide-effect-to-bootstrap-dropdown&usg=ALkJrhiUAKKB2R3djWcvJyrd5EHiyhXJlw
 ...
 */
 $('.navbar .dropdown').hover(function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideDown(); }, function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideUp() });

 $('.navbar .sub-dropdown').hover(function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideDown(); }, function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideUp() });
 
 $('.navbar .dropdown-submenu').hover(function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideDown(); }, function() { $(this).find('.dropdown-menu').first().stop(true, true).delay(300).slideUp() });
